%% run om_decode_timegen_trSNDteOM_MVPALight
clear all
close all
...
condor_struct = obob_condor_addjob_cell(condor_struct, 'om_decode_timegen_trSNDteOM_MVPALight', subjList,chanType,balanceYN,selfRepetitions, Fs, icaClean);
