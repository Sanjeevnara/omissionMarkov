%% run om_decode_timegen_EN_SND_MVPALight
clear all
close all
...
condor_struct = obob_condor_addjob_cell(condor_struct, 'om_decode_timegen_EN_SND_MVPALight', subjList,chanType,Fs,tWindow,preOmissions, manualBalance, icaClean); %struct2cell(cfg)
%fire!
