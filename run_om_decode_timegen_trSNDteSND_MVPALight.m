%% run om_decode_timegen_trSNDteSND_MVPALight
clear all
close all
...
balanceYN = {'yes','no'}; %try both
selfRepetitions  = {'yes','no'}; %try both
Fs = {'100'}; %55 to test, 256 on the cluster ...
icaClean = {'yes'}; %ICA %test also with 'no'

condor_struct = obob_condor_addjob_cell(condor_struct, 'om_decode_timegen_trSNDteSND_MVPALight', subjList,chanType,balanceYN,selfRepetitions, Fs, icaClean);
